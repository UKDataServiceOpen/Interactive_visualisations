...
So, we've all come across the assignment operator '<-' which is used to assign a value. E.g. df <- read_csv('../Data/GI_age.csv'), here we assign our csv file to a dataframe variable called 'df'.
